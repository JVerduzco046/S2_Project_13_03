...
function init() {
      ...
      // Users can change the typing direction either by using the keyboard or by clicking the pointer on an image located below the crossword puzzle.
...
//  This function will format the colors of the crossword table cells and the clues in the clues list based on the letter that is selected by user.
...
// The purpose of this function is to allow users to select puzzle cells using the keyboard. 
...
// to toggle the typing direction between right and down.
